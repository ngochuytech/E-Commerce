...
public class CustomerController {
    ...
    public ResponseEntity<?> getCustomersByStore(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách khách hàng thành công!", customers));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getCustomerById(@PathVariable String customerId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy thông tin khách hàng thành công!", customer));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getCustomerOrders(@PathVariable String customerId, @RequestParam(required = false) String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy lịch sử đơn hàng của khách hàng thành công!", orders));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getCustomerStatistics(@PathVariable String customerId, @RequestParam String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy thống kê khách hàng thành công!", customer));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> searchCustomers(@PathVariable String storeId, @RequestParam String keyword) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Tìm kiếm khách hàng thành công!", customers));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getTopCustomersBySpending(@PathVariable String storeId, @RequestParam(defaultValue = "10") int limit) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách khách hàng chi tiêu cao nhất thành công!", customers));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getNewCustomers(@PathVariable String storeId, @RequestParam(defaultValue = "30") int days) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách khách hàng mới thành công!", customers));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
