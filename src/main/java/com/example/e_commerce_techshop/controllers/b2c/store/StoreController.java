...
public class StoreController {
    ...
    public ResponseEntity<?> createStore(@Valid @RequestBody StoreDTO storeDTO, BindingResult result) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Tạo cửa hàng thành công!", storeResponse));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> updateStore(@PathVariable String storeId, @RequestBody StoreDTO storeDTO, BindingResult result) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Cập nhật cửa hàng thành công!", storeResponse));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getStoreById(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy thông tin cửa hàng thành công!", storeResponse));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getAllStores() {
        ...
        return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách cửa hàng thành công!", stores));
    }
    ...
    public ResponseEntity<?> getStoresByOwner(@PathVariable String ownerId) {
        ...
        return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách cửa hàng theo chủ sở hữu thành công!", stores));
    }
    ...
    public ResponseEntity<?> deleteStore(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Xóa cửa hàng thành công!"));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> approveStore(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Duyệt cửa hàng thành công!", storeResponse));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> rejectStore(@PathVariable String storeId, @RequestParam String reason) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Từ chối cửa hàng thành công!", storeResponse));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getPendingStores() {
        ...
        return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách cửa hàng chờ duyệt thành công!", stores));
    }

    @GetMapping("/approved")
    public ResponseEntity<?> getApprovedStores() {
        List<StoreResponse> stores = storeService.getApprovedStores();
        return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách cửa hàng đã duyệt thành công!", stores));
    }
