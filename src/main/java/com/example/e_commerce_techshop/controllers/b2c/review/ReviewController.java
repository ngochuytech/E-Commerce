...
public class ReviewController {
    ...
    public ResponseEntity<?> getReviewsByProduct(@PathVariable String productId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy đánh giá sản phẩm thành công!", reviews));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getReviewsByProductVariant(@PathVariable String variantId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy đánh giá biến thể sản phẩm thành công!", reviews));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getReviewById(@PathVariable String reviewId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy thông tin đánh giá thành công!", review));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> respondToReview(@PathVariable String reviewId, @RequestParam String response) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Phản hồi đánh giá thành công!", review));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getPendingReviews(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy danh sách đánh giá chờ phản hồi thành công!", reviews));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getReviewStatistics(@PathVariable String storeId) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy thống kê đánh giá thành công!", 
    ...
    public ResponseEntity<?> getReviewsByRating(@PathVariable String storeId, @PathVariable Integer rating) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy đánh giá theo mức độ thành công!", reviews));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getRecentReviews(@PathVariable String storeId, @RequestParam(defaultValue = "10") int limit) {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.ok("Lấy đánh giá gần đây thành công!", reviews));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
