...
public class BuyerCartController {
    ...
    @Operation(
        ...
        description = "Add one or multiple products to the shopping cart. If product already exists, quantity will be updated"
    )
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - validation errors or add failed",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
    public ResponseEntity<?> addToCart(
            @Parameter(
                description = "List of cart items to add including product variant ID and quantity",
                required = true,
                content = @Content(
    ...
    @Operation(
        ...
        description = "Retrieve all items in the current user's shopping cart with detailed product information and totals"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200", 
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - error retrieving cart",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
    ...
    @Operation(
        ...
        description = "Update the quantity of a specific product variant in the shopping cart"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200", 
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - invalid quantity, product not found, or update failed",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
    public ResponseEntity<?> updateCartItem(
            ...
            @Parameter(
                ...
                required = true,
                content = @Content(schema = @Schema(implementation = UpdateQuantityDTO.class))
            )
    ...
    @Operation(
        ...
        description = "Remove a specific product variant completely from the shopping cart"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200", 
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - item not found or removal failed",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
    ...
    @Operation(
        ...
        description = "Remove all items from the shopping cart. This action cannot be undone"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200", 
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - error clearing cart",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
    ...
    @Operation(
        ...
        description = "Retrieve the total number of items in the shopping cart and whether the cart is empty. Useful for cart badge display"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200", 
            description = "Cart count retrieved successfully",
            content = @Content(schema = @Schema(implementation = CartItemCountResponse.class))
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400", 
            description = "Bad request - error retrieving cart count",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))
        )
    })
